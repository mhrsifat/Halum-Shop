...
<?php if ($home_service_on_off == 1) : ?>
    <div class="service bg-gray" style="padding: 10px;">
        <div class="container-fluid">
            <div class="row text-center">
                ...
                foreach ($services as $row) : ?>
                    <div class="col-xs-2">
                        <div class="item">
                            <div class="photo mb-2 fixed-ratio">
                                <img
                                    src="assets/uploads/<?php echo htmlspecialchars($row['photo'], ENT_QUOTES); ?>"
                                    class="img-fluid w-100"
                                    alt="<?php echo htmlspecialchars($row['title'], ENT_QUOTES); ?>">
                            </div>
                            <h3 class="h6">
