                                ...
                                <tr class="<?php if ($row['payment_status'] == 'Pending') {
                                    ...
                                    <td>
                                        ...
                                        ?>
                                            ...
                                            <a class="btn btn-success btn-xs mark-completed-payment"
                                                style="width:100%;margin-bottom:4px;"
                                                data-toggle="modal"
                                                data-target="#confirm-completed-payment"
                                            ...
                                            <a class="btn btn-danger btn-xs mark-failed-payment"
                                                style="width:100%;margin-bottom:4px;"
                                                data-toggle="modal"
                                                data-target="#confirm-failed"
                                                data-id="<?php echo $row['id']; ?>">
                                                Failed
                                            </a>
                                    ...
                                    <td>
                                        ...
                                        ?>
                                                <a class="btn btn-warning btn-xs mark-completed-shipment" style="width:100%;margin-bottom:4px;" data-toggle="modal" data-target="#confirm-completed" data-id="<?php echo $row['id']; ?>">Mark Complete</a>
                                        <?php
                                            }
                                        }
                                        ?>
...
<div class="modal fade" id="confirm-completed" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="myModalLabel">Mark as Confirm</h4>
            </div>
            <div class="modal-body">
                Sure you want to Mark this as Completed?
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                <a href=""
                    class="btn btn-danger click-completed-shipment">Mark As Completed</a>
...
<div class="modal fade" id="confirm-failed" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="myModalLabel">Mark as failed</h4>
            </div>
            <div class="modal-body">
                Sure you want to Mark Failed?
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                <a href=""
                    class="btn btn-danger click-failed-payment">Mark As Failed</a>
...
<div class="modal fade" id="confirm-completed-payment" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            ...
            <div class="modal-body">
                Sure you want to Mark this as Completed as Payment?
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                <a href=""
                    class="btn btn-danger click-completed-payment">Mark As Completed</a>
...
<script>
    // Set Completed Payment URL
    $('.mark-completed-payment').on('click', function() {
        var id = $(this).data('id');
        $('.click-completed-payment').attr('href', 'order-change-status.php?id=' + id + '&task=Completed');
    });

    // Set Failed Payment URL
    $('.mark-failed-payment').on('click', function() {
        var id = $(this).data('id');
        $('.click-failed-payment').attr('href', 'order-change-status.php?id=' + id + '&task=Failed');
    });

    // Set Completed Shipping URL
    $('.mark-completed-shipment').on('click', function() {
        var id = $(this).data('id');
        $('.click-completed-shipment').attr('href', 'shipping-change-status.php?id=' + id + '&task=Completed');
    });
</script>