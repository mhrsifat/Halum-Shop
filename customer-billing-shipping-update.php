...
$(document).ready(function() {
    function syncShippingFields() {
        if ($('#sameAsPermanent').is(':checked')) {
            $('#cust_s_name').val($('#cust_b_name').val());
            $('[name="cust_s_cname"]').val($('[name="cust_b_cname"]').val());
            $('[name="cust_s_phone"]').val($('[name="cust_b_phone"]').val());
            $('[name="cust_s_country"]').val($('[name="cust_b_country"]').val());
            $('[name="cust_s_address"]').val($('[name="cust_b_address"]').val());
            $('[name="cust_s_city"]').val($('[name="cust_b_city"]').val());
            $('[name="cust_s_state"]').val($('[name="cust_b_state"]').val());
            $('[name="cust_s_zip"]').val($('[name="cust_b_zip"]').val());
        }
    }
    ...
    $('#sameAsPermanent').on('change', function() {
        if ($(this).is(':checked')) {
            syncShippingFields(); // Initial copy
        }
    });

    // Listen to billing fields input change to sync dynamically
    $('[name^="cust_b_"]').on('input change', function() {
        if ($('#sameAsPermanent').is(':checked')) {
            syncShippingFields();
        }
    });
